...
所以，团队合作的分支看起来就像这样：
![git_2019-12-05-00-32-43.png](./vx_images/git_2019-12-05-00-32-43.png)
...
1. 首先我们查看当前提交记录
   ![git_2020-01-04-11-18-26.png](./vx_images/git_2020-01-04-11-18-26.png)
2. 我们使用`git rebase -i da0e80b`
   ![git_2020-01-04-11-19-59.png](./vx_images/git_2020-01-04-11-19-59.png)
3. 将`df060c5`前更改为`edit`状态后保存退出
   ![git_2020-01-04-11-21-41.png](./vx_images/git_2020-01-04-11-21-41.png)
4. 使用`git reset --soft HEAD^`,保留第二版的改动回退到第一个版本
   ![git_2020-01-04-11-27-41.png](./vx_images/git_2020-01-04-11-27-41.png)
5. 将改动追加提交到第一个版本即可`git commmit --amend`
   ![git_2020-01-04-11-29-59.png](./vx_images/git_2020-01-04-11-29-59.png)
6. 继续`rebase`,使用`git rebase --continue`
   ![git_2020-01-04-11-30-56.png](./vx_images/git_2020-01-04-11-30-56.png)
